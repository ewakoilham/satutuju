export const landingCopy = {
  id: {
    ...
    hero: {
      ...
      subheadline:
        "Mentoring 1-on-1 dari alumni yang sudah lolos beasiswa. Kami bantu kamu dari persiapan dokumen hingga wawancara — gratis, dengan deposit komitmen Rp 1 juta yang dikembalikan setelah hasil aplikasi keluar.",
      primaryCta: "Gabung Mentorship Sekarang",
      secondaryCta: "Gabung Komunitas",
      statMentors: "Mentor",
      statCountries: "Negara Tujuan",
      statFree: "Deposit Refundable",
...
export type LandingCopy = (typeof landingCopy)["id"];
